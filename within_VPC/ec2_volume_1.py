    ...
    for reservation in response['Reservations']:
        for instance in reservation['Instances']:
            ...
            if volume_ids:
                ...
                for volume in volumes_response['Volumes']:
                    volume_info = {
                        ...
                        'VolumeMetrics': {}  # Initialize empty metrics dictionary
                    }
            ...
            instance_info = {
                ...
                'InstanceMetrics': {}  # Initialize empty metrics dictionary
            }
...
def analyze_instance_and_volume_metrics(regions, start_time, end_time):
    ...
    for region in regions:
        ...
        for instance in running_instances:
            ...
            instance['InstanceMetrics'] = {metric_name: get_cloudwatch_metrics(cloudwatch, 'AWS/EC2', metric_name, unit, [{'Name': 'InstanceId', 'Value': instance['InstanceId']}], start_time, end_time)
